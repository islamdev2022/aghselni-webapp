...
export default function HomeCarWashForm() {
  ...
  return (
    <>
      <h1 className="text-xl md:text-4xl font-bold text-center text-cyan-600 my-4">
        Book Your Home Car Wash Appointment
      </h1>
      <Link
        to="/booking"
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <FormField
                    control={form.control}
                    name="timeSlot"
                    render={({ field }: { field: ControllerRenderProps<z.infer<typeof formSchema>, "timeSlot"> }) => (
                      <FormItem>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <FormField
                    ...
                    render={({
                      field,
                    }: { field: ControllerRenderProps<z.infer<typeof formSchema>, "paymentMethod"> }) => (
                      <FormItem className="space-y-3">
