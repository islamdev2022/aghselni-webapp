...
import { usePendingAppointments, useClaimedAppointments, useAppointmentDetails ,useClaimAppointment, useUpdateAppointmentStatus } from "@/hooks"
...
export default function AppointmentDashboard() {
  ...
  const { data: pendingAppointments, isLoading: isPendingLoading } = usePendingAppointments()
  const { data: claimedAppointments, isLoading: isClaimedLoading } = useClaimedAppointments()
  const { data: appointmentDetails, isLoading: isDetailsLoading } = useAppointmentDetails(selectedAppointment?.id)
